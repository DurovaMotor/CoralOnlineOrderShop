(function () {
  var CART_KEY = "hightac-coralonlineordershop-cart-v1";
  var SUBMISSION_KEY = "hightac-coralonlineordershop-last-submission-v1";
  var LANG_KEY = "hightac-coralonlineordershop-language-v1";
  var DEFAULT_LANG = "fr";
  ...
  function getCatalog() {
    ...
    return {
      model: {
        name: "Coral",
        motorPicture: "Database/MotorPictures/Coral.png"
      },
      parts: []
    };
  }
  ...
  function submitCart() {
    ...
    var modelName = state.catalog.model.name || "Coral";
